...
PACKAGENAME = metadata.get('package_name', 'scintillation')
DESCRIPTION = metadata.get('description', 'Analysis and simulation tools for single-dish and multi-dish radio scintillation data')
AUTHOR = metadata.get('author', 'Robert Main, Olaf Wucknitz, Tim Sprenger')
...
if sys.version_info < tuple((int(val) for val in __minimum_python_version__.split('.'))):
    sys.stderr.write("ERROR: scintillation requires Python {} or later\n".format(__minimum_python_version__))
    sys.exit(1)
